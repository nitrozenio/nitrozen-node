...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NitrozenApi.PublicApi();
  });
  ...
  describe('PublicApi', function() {
    describe('publicProjectsSlugEntriesGet', function() {
      it('should call publicProjectsSlugEntriesGet successfully', function(done) {
        //uncomment below and update the code to test publicProjectsSlugEntriesGet
        //instance.publicProjectsSlugEntriesGet(function(error) {
