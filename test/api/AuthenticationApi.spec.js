...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NitrozenApi.AuthenticationApi();
  });
  ...
  describe('AuthenticationApi', function() {
    ...
    describe('tokensTokenDelete', function() {
      it('should call tokensTokenDelete successfully', function(done) {
        //uncomment below and update the code to test tokensTokenDelete
        //instance.tokensTokenDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
