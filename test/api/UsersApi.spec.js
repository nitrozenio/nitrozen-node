...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NitrozenApi.UsersApi();
  });
  ...
  describe('UsersApi', function() {
    ...
    describe('userUsageGet', function() {
      it('should call userUsageGet successfully', function(done) {
        //uncomment below and update the code to test userUsageGet
        //instance.userUsageGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
