...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NitrozenApi.ProjectsApi();
  });
  ...
  describe('ProjectsApi', function() {
    ...
    describe('projectsProjectDelete', function() {
      it('should call projectsProjectDelete successfully', function(done) {
        //uncomment below and update the code to test projectsProjectDelete
        //instance.projectsProjectDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('projectsProjectGet', function() {
      it('should call projectsProjectGet successfully', function(done) {
        //uncomment below and update the code to test projectsProjectGet
        //instance.projectsProjectGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('projectsProjectPut', function() {
      it('should call projectsProjectPut successfully', function(done) {
        //uncomment below and update the code to test projectsProjectPut
        //instance.projectsProjectPut(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
