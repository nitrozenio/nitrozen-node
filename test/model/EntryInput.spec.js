...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NitrozenApi.EntryInput();
  });
  ...
  describe('EntryInput', function() {
    it('should create an instance of EntryInput', function() {
      // uncomment below and update the code to test EntryInput
      //var instance = new NitrozenApi.EntryInput();
      //expect(instance).to.be.a(NitrozenApi.EntryInput);
    });
