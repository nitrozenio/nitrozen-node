...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NitrozenApi.NewToken();
  });
  ...
  describe('NewToken', function() {
    it('should create an instance of NewToken', function() {
      // uncomment below and update the code to test NewToken
      //var instance = new NitrozenApi.NewToken();
      //expect(instance).to.be.a(NitrozenApi.NewToken);
    });
