...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NitrozenApi.PublicProjectsSlugEntriesGet200Response();
  });
  ...
  describe('PublicProjectsSlugEntriesGet200Response', function() {
    it('should create an instance of PublicProjectsSlugEntriesGet200Response', function() {
      // uncomment below and update the code to test PublicProjectsSlugEntriesGet200Response
      //var instance = new NitrozenApi.PublicProjectsSlugEntriesGet200Response();
      //expect(instance).to.be.a(NitrozenApi.PublicProjectsSlugEntriesGet200Response);
    });
