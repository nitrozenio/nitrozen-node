...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NitrozenApi.Usage();
  });
  ...
  describe('Usage', function() {
    it('should create an instance of Usage', function() {
      ...
      //var instance = new NitrozenApi.Usage();
      //expect(instance).to.be.a(NitrozenApi.Usage);
    });

    it('should have the property projectsCount (base name: "projects_count")', function() {
      // uncomment below and update the code to test the property projectsCount
      //var instance = new NitrozenApi.Usage();
      //expect(instance).to.be();
    });

    it('should have the property entriesThisMonth (base name: "entries_this_month")', function() {
      // uncomment below and update the code to test the property entriesThisMonth
      //var instance = new NitrozenApi.Usage();
      //expect(instance).to.be();
    });
