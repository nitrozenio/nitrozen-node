...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NitrozenApi.ProjectsProjectEntriesPost201Response();
  });
  ...
  describe('ProjectsProjectEntriesPost201Response', function() {
    it('should create an instance of ProjectsProjectEntriesPost201Response', function() {
      // uncomment below and update the code to test ProjectsProjectEntriesPost201Response
      //var instance = new NitrozenApi.ProjectsProjectEntriesPost201Response();
      //expect(instance).to.be.a(NitrozenApi.ProjectsProjectEntriesPost201Response);
    });
